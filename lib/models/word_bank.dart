...
class WordBank {
  ...
  static const Map<WordCategory, List<WordPair>> _pairs = {
    WordCategory.everydayObjects: [
      ...
      WordPair('Suklay', ['Groom', 'Hair', 'Teeth']),
      WordPair('Balde', ['Round', 'Bucket', 'Water', 'Carry']),
    ],
    ...
    WordCategory.food: [
      ...
      WordPair('Kwek-kwek', ['Orange', 'Street', 'Eggs', 'Fried']),
      WordPair('Balut', ['Duck', 'Street', 'Fertilized', 'Boiled']),
      WordPair('Taho', ['Sweet', 'Street', 'Soft', 'Sugar']),
      WordPair('Leche Flan', ['Sweet', 'Caramel', 'Custard', 'Milk']),
      WordPair('Lechon', ['Roast', 'Street', 'Pork', 'Spit', 'Crispy']),
      WordPair('Halo-halo', ['Cold', 'Street', 'Sweet', 'Mixed']),
      WordPair('Sinigang', ['Sour', 'Pork', 'Tamarind']),
      WordPair('Adobo', ['Soy Sauce', 'Vinegar', 'Garlic', 'Bay Leaf']),
    ],
    WordCategory.places: [
      ...
      WordPair('Banaue Rice Terraces', ['Steps', 'Terrace', 'Mountain', 'Rice']),
      WordPair('Mayon Volcano', ['Cone', 'Volcano', 'Active', 'Eruption']),
      WordPair('Boracay', ['Beach', 'Island', 'White sand', 'White beach']),
    ],
    WordCategory.movies: [
    ...
    WordCategory.brandsLogos: [
      ...
      WordPair('Jollibee', ['Mascot', 'Joy', 'Bee']),
      WordPair('Angel\'s Burger', ['Cheap', 'Affordable', 'Bun']),
      WordPair('National Bookstore', ['Books', 'School', 'Supplies']),
      WordPair('Robinsons', ['Mall', 'Shopping', 'Department-store']),
      WordPair('SM', ['Mall', 'Shopping', 'Department-store']),
      WordPair('Savemore', ['Supermarket', 'Groceries', 'Shopping']),
    ],
